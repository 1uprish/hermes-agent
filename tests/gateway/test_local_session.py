...
def test_fresh_local_session_owns_execution_across_viewers(tmp_path):
    ...
    result = subprocess.run(
        [sys.executable, str(Path(__file__).parent / 'fixtures' / 'local_session_peer.py')],
    ...
    assert receipt['terminal_effect'] and receipt['same_agent'] and receipt['detached_pending']
