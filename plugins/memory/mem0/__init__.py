...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def _create_backend(self):
        # Lazy-install the mem0 SDK before the backend imports it (pm honors
        # security.allow_lazy_installs); on failure the backend import raises
        # the canonical error, captured below.
        with suppress(Exception):
