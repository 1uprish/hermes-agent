...
_DESCRIPTION_HEAD = (
    ...
    "Runs in the background: dispatch returns immediately with live transcript paths, and each completed result "
    "re-enters the conversation on its own as soon as that subagent finishes. Do NOT wait or poll; continue "
